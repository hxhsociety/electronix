...
```bash
# Create repo at github.com/HxHSociety/ElectroniX (or your org)
gh repo create HxHSociety/ElectroniX --public --source=. --remote=origin
...
```
https://github.com/HxHSociety/ElectroniX/releases/latest/download/latest.json
```
